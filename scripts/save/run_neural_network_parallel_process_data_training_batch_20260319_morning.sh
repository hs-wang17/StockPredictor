...
: "${BEGIN_PERIOD:=0}"
: "${CRITERION:=mse}"
: "${DATA_DIR:=/home/haris/raid0/shared/haris/mydata_20251231/concat_daily_factor_with_label_10_index}"
: "${DEVICE:=cuda:0}"
: "${END_DATE:=20301231}"
: "${EPOCHS:=200}"
...
: "${START_DATE:=20180401}"
: "${TRADE_DATE_PATH:=/home/haris/mydata_20251231/trade_date_10.fea}"
: "${TRAIN_BATCH_SIZE:=1}"
