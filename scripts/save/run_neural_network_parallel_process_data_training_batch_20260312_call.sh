...
: "${BEGIN_PERIOD:=0}"
: "${CRITERION:=mse}"
: "${DATA_DIR:=/home/haris/raid0/shared/haris/mydata_20260311/concat_daily_factor_with_label}"
: "${DEVICE:=cuda:0}"
: "${END_DATE:=20301231}"
: "${EPOCHS:=80}"
...
: "${START_DATE:=20180401}"
: "${TRADE_DATE_PATH:=/home/haris/raid0/shared/haris/mydata_20260311/trade_date.fea}"
: "${TRAIN_BATCH_SIZE:=1}"
