...
: "${BEGIN_PERIOD:=0}"
: "${CRITERION:=mse}"
: "${DATA_DIR:=/home/haris/raid0/shared/haris/mydata_20260127/concat_daily_factor_with_label_10}"
: "${DEVICE:=cuda:0}"
: "${END_DATE:=20301231}"
: "${EPOCHS:=80}"
: "${FILTER_FILE_PATH:=/home/haris/raid0/shared/haris/mydata_20260127/feature_selection/selected_factor_index_correlation_matrix_10.csv}"
: "${FROM_START:=False}"
: "${GAP_DAYS:=10}"
: "${HIDDEN_DIM:=64}"
: "${INVERSE:=False}"
