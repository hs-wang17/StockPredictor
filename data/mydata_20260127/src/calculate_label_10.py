...
label_10.to_feather("/home/haris/raid0/shared/haris/mydata_20260127/label_10.fea")
trade_date_df = pd.DataFrame({"trade_date": label_10.index})
trade_date_df.reset_index(drop=True).to_feather("/home/haris/raid0/shared/haris/mydata_20260127/trade_date_10.fea")
