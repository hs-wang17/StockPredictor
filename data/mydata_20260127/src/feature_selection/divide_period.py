...
os.makedirs("/home/haris/raid0/shared/haris/mydata_20260127/feature_selection", exist_ok=True)

trade_date = pd.read_feather("/home/haris/raid0/shared/haris/mydata_20260127/trade_date.fea")["trade_date"].to_list()
...
with open("/home/haris/raid0/shared/haris/mydata_20260127/feature_selection/train_predict_period.json", "w") as f:
    json.dump({"num_periods": num_periods, "train_dates_list": train_dates_list, "predict_dates_list": predict_dates_list}, f, indent=4)

trade_date = pd.read_feather("/home/haris/raid0/shared/haris/mydata_20260127/trade_date_10.fea")["trade_date"].to_list()
trade_date = [date for date in trade_date if date >= "20180401"]
num_periods, train_dates_list, predict_dates_list = generate_train_predict_dates(trade_date)
with open("/home/haris/raid0/shared/haris/mydata_20260127/feature_selection/train_predict_period_10.json", "w") as f:
    json.dump({"num_periods": num_periods, "train_dates_list": train_dates_list, "predict_dates_list": predict_dates_list}, f, indent=4)

trade_date = pd.read_feather("/home/haris/raid0/shared/haris/mydata_20260127/trade_date_mix.fea")["trade_date"].to_list()
trade_date = [date for date in trade_date if date >= "20180401"]
num_periods, train_dates_list, predict_dates_list = generate_train_predict_dates(trade_date)
with open("/home/haris/raid0/shared/haris/mydata_20260127/feature_selection/train_predict_period_mix.json", "w") as f:
    json.dump({"num_periods": num_periods, "train_dates_list": train_dates_list, "predict_dates_list": predict_dates_list}, f, indent=4)
