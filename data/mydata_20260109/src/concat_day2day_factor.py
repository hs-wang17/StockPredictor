...
save_dir = "/home/haris/mydata_20260109/concat_day2day_factor"
os.makedirs(save_dir, exist_ok=True)
# factor_types = os.listdir(data_dir)
factor_types = [d for d in os.listdir(data_dir)]
date_list = []
...
for date in tqdm([date for date in date_list if date >= "20180101"]):
    df_list = []
    for factor_type in factor_types:
...
trade_date_df.to_feather("/home/haris/mydata_20260109/trade_date.fea")
