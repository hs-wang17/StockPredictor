...
save_dir_copy = "/home/haris/raid0/shared/haris/mydata_20251231/concat_daily_factor_with_label_10"
os.makedirs(save_dir_copy, exist_ok=True)
label_df = pd.read_feather("/home/haris/raid0/shared/haris/mydata_20251231/label_10.fea")
factor_files = sorted(os.listdir(factor_dir))[:-11]
for factor_file in tqdm(factor_files[-1:]):  # 只计算最后一天
    ...
    factor_with_label.to_feather(os.path.join(save_dir_copy, factor_file))
