...
class FactorSelectionFramework:
    ...
    def _select_factors_single_period_static(period_idx: int, 
        ...
        remaining.sort(key=lambda x: -rankic_values[x], reverse=True)  # TODO: abs(rankic)
...
def process_single_suffix(suffix: str, correlation_threshold: float = 0.7, 
    ...
    处理单个后缀的因子筛选
    """
    correlation_path = f"/home/haris/raid0/shared/haris/mydata_20251231/feature_selection/period_correlation_matrix{suffix}.csv"
    rankic_path = f"/home/haris/raid0/shared/haris/mydata_20251231/feature_selection/period_rankic_mean{suffix}.csv"
    output_path = f"/home/haris/raid0/shared/haris/mydata_20251231/feature_selection/selected_factor_index_correlation_matrix{suffix}.csv"
