...
def main():
    suffixes = ["", "_10", "_mix"]
    for s in suffixes:
        correlation_path = f"/home/haris/raid0/shared/haris/mydata_20251231/feature_selection/period_correlation_matrix{s}.csv"
        rankic_path = f"/home/haris/raid0/shared/haris/mydata_20251231/feature_selection/period_rankic_mean{s}.csv"
        output_path = f"/home/haris/raid0/shared/haris/mydata_20251231/feature_selection/selected_factor_index_correlation_matrix{s}.csv"
